...
//============================================================================
Portal::Portal(b2World* world, int bodyT, const sf::Vector2f& pos,
	...
	:StaticObject(world, bodyT, pos, rotation, size, gameObj)
{
	...
	m_animation->addAnimation("Default", 100.f, Resources::instance().getAnimInfo((int)Animations::Portal), size);
}
//============================================================================